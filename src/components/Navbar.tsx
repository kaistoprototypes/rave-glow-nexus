  ...
  return (
    <header className="sticky top-0 z-40 glass border-b border-border/40">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-8">
        <Link to="/" className="flex items-center gap-2 text-lg font-display font-black tracking-tight">
          <Sparkles className="h-5 w-5 text-[color:var(--lime)] glow-lime" />
          <span className="text-neon">ELECTRIC PULSE</span>
        </Link>
